...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3292332;
      var PACKAGE_UUID = '747151de-6329-488d-983d-4cf234559091';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 306964, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(306964, 306985, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(306985, 307103, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(307103, 1768647, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(1768647, 3264707, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3264707, 3292332, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
